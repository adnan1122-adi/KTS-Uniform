...
const NotificationModal: React.FC<NotificationModalProps> = ({ message, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="bg-blue-50/50 p-6 flex items-center justify-between border-b border-blue-50 shrink-0">
        ...
        <div className="p-8 space-y-8 overflow-y-auto flex-1 custom-scrollbar">
          {message.english && (
            <div className="space-y-2">
              ...
              <p className="text-gray-700 leading-relaxed text-lg whitespace-pre-wrap">{message.english}</p>
            </div>
          )}
          ...
          {message.arabic && (
            <div className="space-y-2 text-right">
              ...
              <p className="text-gray-700 leading-relaxed text-xl font-arabic whitespace-pre-wrap" dir="rtl">{message.arabic}</p>
            </div>
          )}
        </div>

        <div className="p-6 bg-gray-50 flex justify-center border-t border-gray-100 shrink-0">
          <button
            onClick={onClose}
